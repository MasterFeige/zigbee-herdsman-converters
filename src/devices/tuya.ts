...
export const definitions: DefinitionWithExtend[] = [
    ...
    },
    {
        ...
        model: 'ZS-301Z',
        vendor: 'arteco',
        description: 'Suitable for agriculture and home planting, this sensor is capable of detecting soil moisture, light intensity, and ambient temperature and humidity. It adopts low power consumption to ensure long-term operation of the device.Create by Feige',
        fromZigbee: [tuya.fz.datapoints],
        toZigbee: [tuya.tz.datapoints],
        onEvent: tuya.onEventSetTime,
        configure: tuya.configureMagicPacket,
        exposes: [
            ...
            e.numeric('adjust_humidity',ea.STATE_SET).withUnit('%RH').withDescription('Adjust humidity').withValueMin(-30).withValueMax(30).withValueStep(1),
            e.numeric('adjust_sample_time',ea.STATE_SET).withUnit('s').withDescription('Adjust sample time').withValueMin(30).withValueMax(1200).withValueStep(30),
        ],
        meta: {
            tuyaDatapoints: [
